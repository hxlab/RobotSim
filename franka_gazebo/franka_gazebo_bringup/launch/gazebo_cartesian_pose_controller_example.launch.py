...
def generate_launch_description():
    ...
    load_cartesian_pose_example_controller = ExecuteProcess(
        cmd=['ros2', 'control', 'load_controller', '--set-state', 'active', 'cartesian_pose_example_controller'],
        output='screen'
    )
    ...
    return LaunchDescription([
        ...
        RegisterEventHandler(
            event_handler=OnProcessExit(
                ...
                on_exit=[load_cartesian_pose_example_controller],
            )
        ),
        Node(
